...
def on_message(client, userdata, msg):
    ...
    if msg.topic == "esp32/alarm1":
        ...
        elif str(msg.payload) == "b'one'":
            print(flag)
            flag = True
            msgs = [("esp32/green1","off"),("esp32/green2","on"),("esp32/green3","on"),("esp32/green4","on")]
            publish.multiple(msgs,hostname="192.168.1.5",port=1883,keepalive=60)
        ...
        if str(msg.payload) == "b'on'":
            ...
            print(flag)
            flag = True
            msgs = [("esp32/green1","on"),("esp32/green2","off"),("esp32/green3","on"),("esp32/green4","on")]
            publish.multiple(msgs,hostname="192.168.1.5",port=1883,keepalive=60)   
        elif str(msg.payload) == "b'off'":
            flag = False
        ...
        if str(msg.payload) == "b'on'":
            ...
            print(flag)
            flag = True
            msgs = [("esp32/green1","on"),("esp32/green2","on"),("esp32/green3","off"),("esp32/green4","on")]
            publish.multiple(msgs,hostname="192.168.1.5",port=1883,keepalive=60)
        elif str(msg.payload) == "b'off'":
            flag = False
        ...
        if str(msg.payload) == "b'on'":
            ...
            publish.multiple(msgs,hostname="192.168.1.5",port=1883,keepalive=60)
            flag = True
        if str(msg.payload) == "b'one'":
            print(flag)
            flag = True
            msgs = [("esp32/green1","on"),("esp32/green2","on"),("esp32/green3","on"),("esp32/green4","off")]
            publish.multiple(msgs,hostname="192.168.1.5",port=1883,keepalive=60)    
        elif str(msg.payload) == "b'off'":
            flag = False
...
while True:
    ...
    while flag == False:
        ...
        publish.multiple(msg,hostname="192.168.1.5",port=1883,keepalive=60)
        time.sleep(1)
